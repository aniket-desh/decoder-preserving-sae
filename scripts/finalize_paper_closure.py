...
CODE_PATHS = (
    ...
    "scripts/run_paper_closure_queue.sh",
    "scripts/run_mechanism_queue.sh",
    "scripts/run_generality_queue.sh",
    "scripts/run_jumprelu_queue.sh",
    "scripts/run_finalize_queue.sh",
    "scripts/run_backup_queue.sh",
