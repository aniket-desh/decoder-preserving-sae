...
def main() -> None:
    ...
    if args.write_contract:
        if any((args.payload, args.release_manifest, args.output_dir)):
        ...
        return
    if not all((args.payload, args.release_manifest, args.output_dir)):
        raise ValueError("rendering requires payload, release manifest, and output directory")
